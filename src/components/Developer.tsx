...
const Developer: React.FC<DeveloperProps> = ({ animationName = 'idle', ...props }) => {
  ...
  const { animations: idleAnimation } = useFBX('/models/animations/idle.fbx') as any;
  const { animations: saluteAnimation } = useFBX('/models/animations/salute.fbx') as any;
  const { animations: clappingAnimation } = useFBX('/models/animations/clapping.fbx') as any;
  const { animations: victoryAnimation } = useFBX('/models/animations/victory.fbx') as any;
